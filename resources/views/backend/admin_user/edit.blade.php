        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.admin-user.update', $admin_user->id) }}" method="POST" id="update">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" autocomplete="off" class="form-control" value="{{ $admin_user->name }}">
                </div>
                <div class="form-group">
                    <label for="">Email</label>
                    <input type="text" autocomplete="off" name="email" class="form-control" value="{{ $admin_user->email }}">
                </div>
                <div class="form-group">
                    <label for="">Phone</label>
                    <input type="text" name="phone" autocomplete="off" class="form-control" value="{{ $admin_user->phone }}">
                </div>
                <div class="form-group">
